...
namespace plugins\ApkPacker;

require "Lib/ZipStream.php";
require "Exception/ApkPackerException.php";

use plugins\ApkPacker\Exception\ApkPackerException;
use plugins\ApkPacker\Lib\ZipStream;
...
//				throw new ApkPackerException( 'apk file is already exists' );
	...
	public function unPackerSingleApk($apkFile){

    }

	private function _readZipComment($apkFile){
        $this->zipStream->open( $apkFile );
        return $this->zipStream->readZipComment();
    }
